  ...
  return (
    <section className="space-y-4">
      ...
      <Card className="p-0 overflow-hidden">
        <CardHeader className="border-b border-(--color-line) bg-slate-950/80 px-4 py-3">
        ...
        <CardContent className="p-0">
          <pre
            ref={preRef}
            className="m-0 max-h-[70vh] min-h-[70vh] overflow-auto whitespace-pre-wrap break-words p-4 text-[13px] leading-relaxed font-mono"
          >
            {content}
          </pre>
        </CardContent>
